var grid = $("#dataTable").bootstrapTable({
    url: "//itech-admin-api.iskwen.com/api/recharge/listRechargeRecord",
    ...
    exportOptions: {
        fileName: 'listRechargeRecord' + "_" + getFileName(),  //文件名称设置
        worksheetName: 'sheet1',  //表格工作区名称
        tableName: 'listRechargeRecord',
    ...
    columns: [{
        ...
        width: 100,
        formatter: function (value, row, index) {
            return "<button type='button' class='btn btn-warning btn-rounded btn-xs ly2-tips' ly2-tips-text='[cardId:" + row.card_id + "]' data-clipboard-text='" + value + "'>"+value+"</button>";
        }
    }, {
        field: 'amount',
        title: '金額',
        ...
        formatter: function (value, row, index) {
            if (value == 1) {
                return "<button class='btn btn-primary btn-rounded btn-xs ly2-tips' ly2-tips-text='充值成功~' ly2-tips-color='#23C6C9'>成功</a>";
            } else if (value == 2) {
                return "<button class='btn btn-danger btn-rounded btn-xs ly2-tips' ly2-tips-text='充值失敗!' ly2-tips-color='#F8AC59'>失敗</a>";
            } else {
...
function deleteOne(id, deleted) {
    ...
    showConfirm("溫馨提示", content, function (index) {
        $.ajax({
            url: "//itech-admin-api.iskwen.com/api/recharge/deleteRechargeRecord",
            type: "post",
            dataType: "json",
...
function batchDelete(deleted) {
    ...
    showConfirm("溫馨提示", content, function (index) {
        ...
        $.ajax({
            url: "//itech-admin-api.iskwen.com/api/recharge/batchDeleteRechargeRecord",
            type: "post",
            dataType: "json",
...
function changeState(id, state) {
        $.ajax({
            url: "//itech-admin-api.iskwen.com/api/recharge/changeRechargeRecordState",
            type: "post",
            dataType: "json",
...
function batchUpdateState(state) {
    ...
    showConfirm("溫馨提示", content, function (index) {
        ...
        $.ajax({
            url: "//itech-admin-api.iskwen.com/api/recharge/batchUpdateRechargeRecordState",
            type: "post",
            dataType: "json",
