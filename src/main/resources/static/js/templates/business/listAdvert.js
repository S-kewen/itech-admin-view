var grid = $("#dataTable").bootstrapTable({
    url: "//itech-admin-api.iskwen.com/api/business/listAdvert",
    ...
    exportOptions: {
        fileName: 'listAdvert' + "_" + getFileName(),  //文件名称设置
        worksheetName: 'sheet1',  //表格工作区名称
        tableName: 'listAdvert',
    ...
    columns: [{
    ...
    },
        {
            ...
            formatter: function (value, row, index) {
                ...
                result+="<button class='layui-btn layui-btn-xs layui-btn-warm' lay-href='business/editAdvert?id="+row.id+"&byUrl=business/listAdvert&byText=廣告管理' lay-text='編輯廣告'>編輯</button>";
                if (row.deleted) {
...
function deleteOne(id, deleted) {
    ...
    showConfirm("溫馨提示", content, function (index) {
        $.ajax({
            url: "//itech-admin-api.iskwen.com/api/business/deleteAdvert",
            type: "post",
            dataType: "json",
...
function batchDelete(deleted) {
    ...
    showConfirm("溫馨提示", content, function (index) {
        ...
        $.ajax({
            url: "//itech-admin-api.iskwen.com/api/business/batchDeleteAdvert",
            type: "post",
            dataType: "json",
...
function changeState(id, state) {
        $.ajax({
            url: "//itech-admin-api.iskwen.com/api/business/changeAdvertState",
            type: "post",
            dataType: "json",
...
function batchUpdateState(state) {
    ...
    showConfirm("溫馨提示", content, function (index) {
        ...
        $.ajax({
            url: "//itech-admin-api.iskwen.com/api/business/batchUpdateAdvertState",
            type: "post",
            dataType: "json",
