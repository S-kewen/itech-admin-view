var grid = $("#dataTable").bootstrapTable({
    url: "//itech-admin-api.iskwen.com/api/express/listExpressScore",
    ...
    exportOptions: {
        fileName: 'listExpressScore' + "_" + getFileName(),  //文件名称设置
        worksheetName: 'sheet1',  //表格工作区名称
        tableName: 'listExpressScore',
    ...
    columns: [{
        ...
        formatter: function (value, row, index) {
            if(value===1){
                return "<button type='button' class='btn btn-info btn-rounded btn-xs ly2-tips' ly2-tips-text='發單者~'>發單者</button>";
            }else if(value===2){
                return "<button type='button' class='btn btn-primary btn-rounded btn-xs ly2-tips' ly2-tips-text='發單者~'>接單者</button>";
            }else{
        ...
        formatter: function (value, row, index) {
            if (value === 1 ) {
                return "<button type='button' class='btn btn-info btn-rounded btn-xs ly2-tips' ly2-tips-text='不匿名~'>正常</button>";
            }else{
                return "<button type='button' class='btn btn-primary btn-rounded btn-xs ly2-tips' ly2-tips-text='注意保護用戶隱私哦~'>匿名</button>";
            }
        }
    }, {
        field: 'score',
...
function deleteExpressScore(id, deleted) {
    ...
    showConfirm("溫馨提示", content, function (index) {
        $.ajax({
            url: "//itech-admin-api.iskwen.com/api/express/deleteExpressScore",
            type: "post",
            dataType: "json",
...
function batchDelete(deleted) {
    ...
    showConfirm("溫馨提示", content, function (index) {
        ...
        $.ajax({
            url: "//itech-admin-api.iskwen.com/api/express/batchDeleteExpressScore",
            type: "post",
            dataType: "json",
